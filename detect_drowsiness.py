...
ALARM_PATH = "E:/Driver-Drowsiness-Detection-and-Alert-System-main/assets/alarm.mp3"
...
def lip_distance(shape_lips):
    top_lip = shape_lips[50:53]
    top_lip = np.concatenate((top_lip, shape_lips[61:64]))

    low_lip = shape_lips[56:59]
    low_lip = np.concatenate((low_lip, shape_lips[65:68]))
...
COUNTER = 0
ALARM_ON = False
predictor_lips = dlib.shape_predictor('E:/Driver-Drowsiness-Detection-and-Alert-System-main/datasets/shape_predictor_68_face_landmarks.dat')
...
while True:
    ...
    for rect in rects:
        ...
        shape_lips = predictor_lips(gray, rect)
        shape_lips = face_utils.shape_to_np(shape_lips)
        ...
        distance = lip_distance(shape_lips)
        lip = shape_lips[48:60]
    ...
    # show the frame
    cv2.imshow("Drowsiness Detection And Alert System", frame)
